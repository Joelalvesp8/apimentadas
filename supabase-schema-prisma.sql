...
-- CreateIndex
CREATE UNIQUE INDEX "card_likes_user_id_card_id_key" ON "card_likes"("user_id", "card_id");

-- CreateIndex
CREATE UNIQUE INDEX "card_likes_user_id_user_card_id_key" ON "card_likes"("user_id", "user_card_id");

-- CreateIndex
CREATE UNIQUE INDEX "session_participants_session_id_profile_id_key" ON "session_participants"("session_id", "profile_id");
